...
<link
	...
	function orderGet(orderId){
		if(confirm("订单号"+orderId+"的订单确认取货？")){
			location.href='${pageContext.request.contextPath }/simpleorder/orderget/'+orderId;
		}
	}
	</script>
</head>
<body>
<div style="margin-left:1%;width；98%;font-size: 14px">
<a class="button button-tiny" href='${pageContext.request.contextPath}/simpleorder/init'><font size="3"><i class="fa fa-reorder fa-1x"></i>&nbsp;订单中心</font></a>-<a class="button button-tiny"><font size="3"><i class="fa fa-file-text-o fa-1x"></i>&nbsp;详细信息</font></a><br>
<hr>
...
<tr>
<td>订单评价星级</td>
<td colspan="5"><c:forEach step="1" begin="1" end="${order.orderRemark}">
<font color="#1b9af7"><i class="fa fa-star fa-2x"></i></font>
</c:forEach></td>
</tr>
<tr>
<td>订单评价内容</td>
...
<tr>
<td colspan="2"><button onclick="orderGet('${order.orderId}')" class="button button-primary button-small" <c:if test="${order.orderStatus !=2}"> disabled="disabled"</c:if>>确认收货</button></td>
<td colspan="2"></td>
<td colspan="2"><button onclick="location.href='${pageContext.request.contextPath }/simpleorder/init'"class="button button-primary button-small">返回</button></td>
</tr>
</table>
</div>
</body>
