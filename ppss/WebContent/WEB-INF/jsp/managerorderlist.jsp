...
function orderInfo(orderId){
	location.href='${pageContext.request.contextPath}/manager/orderinfo/'+orderId;
}
</script>
</head>
<body>
<div style="margin-left:1%;width:98%">
<a class="button button-tiny"><font size="3"><i class="fa fa-reorder fa-1x"></i>&nbsp;订单管理</font></a><br>
<hr>
<form action="${pageContext.request.contextPath}/manager/ordersearch" method="post">
<table width="100%">
<tr>
<td>订单号</td>
<td><input type="text" name="orderId" value="${order.orderId}"></td>
<td>下单用户编号</td>
<td><input type="text" name="userId" value="${order.userId}"></td>
<td>订单状态</td>
...
<td>订单发货时间</td>
<td><input type="text" name="sendTime" class="Wdate" value="${order.sendTime}"
						onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"></td>
</tr>
<tr>
<td>订单取货时间</td>
<td><input type="text" name="getTime" class="Wdate" value="${order.sendTime}"
						onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"></td>
<td colspan="7"></td>
